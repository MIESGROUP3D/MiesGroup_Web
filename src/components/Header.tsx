 ...
 * botón "Menú" + panel lateral, SideMenu). En la home flota en blanco sobre
 * el hero a pantalla completa; en el resto de páginas ocupa su fila, en negro.
 */
export function Header() {
  const overHero = usePathname() === "/";
  return (
    <header className={cn("shell flex h-16 items-center", overHero && "absolute inset-x-0 top-0 z-20 text-paper")}>
